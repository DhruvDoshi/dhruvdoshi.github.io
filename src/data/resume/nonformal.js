const nonformal = [
...

  {
    ...
    points: [
      ...
      'Held 6 sessions as a CCC Regional Congress member',
      'Wrote 2 blog posts about Artificial Intelligence',
      'CCC TedX Speaker',
    ],
  },

  {
    ...
    points: [
      ...
      'Introduced TUMO\'s VR project during WCIT 2019.',
    ],
  },

  {
    ...
    points: [
      ...
      'Robotics club leader of high schoolers.',
    ],
  },
...

  {
    ...
    points: [
      ...
      'Joined the Taland startup.',
    ],
  },

  {
    company: 'NVIDIA & YSU - ',
    position: '"Data Science in Business" master\'s degree\'s summer program',
    link: 'https://www.istc.am/data-science-for-business',
    daterange: 'July 3, 2020 - July 19, 2020',
    points: [
      'Out of 400 graduate student applicants, was 1/30 that was accepted (the only tenth grader)',
      'Completed 2-week classes about Deep Learning and Machine Learning',
      'As the final project, had a computer vision task',
    ],
  },

  {
    company: 'TechnoLab',
    link: 'https://www.facebook.com/YerevanTechnoLab/',
    daterange: '2018 - 2019',
    points: [
      'Completed a Game Development Course.',
      'Learned JavaScript and Phaser',
    ],
  },
